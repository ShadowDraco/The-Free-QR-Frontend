...
import EditQRForm from "../forms/EditQRForm";

export default function FlyoutForm({ selectedQRCode }) {
  return (
    <Popover className="relative gap-5 justify-around mt-20 p-3 w-full bg-gradient-to-br from-indigo-300 to-purple-100">
      ...
      >
        <div className="w-screen max-w-xl flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
          <div className="p-4">
            <EditQRForm selectedQRCode={selectedQRCode} />
          </div>
        </div>
      </PopoverPanel>
    </Popover>
